        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left min-w-[600px]">
            <thead className="bg-muted/30 border-b border-border select-none">
              <tr>
                <th onClick={() => handleSort("identifier")} className="px-4 md:px-6 py-4 text-xs font-bold uppercase tracking-wider text-muted-foreground opacity-70 cursor-pointer hover:bg-muted hover:text-foreground transition-colors group">Identifier <SortIcon field="identifier" /></th>
                <th onClick={() => handleSort("areaCode")} className="px-4 md:px-6 py-4 text-xs font-bold uppercase tracking-wider text-muted-foreground opacity-70 cursor-pointer hover:bg-muted hover:text-foreground transition-colors group">Area Code <SortIcon field="areaCode" /></th>
                <th onClick={() => handleSort("roles")} className="px-4 md:px-6 py-4 text-xs font-bold uppercase tracking-wider text-muted-foreground opacity-70 cursor-pointer hover:bg-muted hover:text-foreground transition-colors group">Access Roles <SortIcon field="roles" /></th>
                <th onClick={() => handleSort("createdAt")} className="px-4 md:px-6 py-4 text-xs font-bold uppercase tracking-wider text-muted-foreground opacity-70 cursor-pointer hover:bg-muted hover:text-foreground transition-colors group">Member Since <SortIcon field="createdAt" /></th>
                {isSuperAdmin && <th onClick={() => handleSort("appVersion")} className="px-4 md:px-6 py-4 text-xs font-bold uppercase tracking-wider text-muted-foreground opacity-70 cursor-pointer hover:bg-muted hover:text-foreground transition-colors group">App Version <SortIcon field="appVersion" /></th>}
                {isSuperAdmin && <th onClick={() => handleSort("lastUsedAt")} className="px-4 md:px-6 py-4 text-xs font-bold uppercase tracking-wider text-muted-foreground opacity-70 cursor-pointer hover:bg-muted hover:text-foreground transition-colors group">Last Used At <SortIcon field="lastUsedAt" /></th>}
                {isSuperAdmin && <th onClick={() => handleSort("platform")} className="px-4 md:px-6 py-4 text-xs font-bold uppercase tracking-wider text-muted-foreground opacity-70 cursor-pointer hover:bg-muted hover:text-foreground transition-colors group">Platform <SortIcon field="platform" /></th>}
